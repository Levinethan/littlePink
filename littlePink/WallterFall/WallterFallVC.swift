...
class WallterFallVC: UICollectionViewController, CHTCollectionViewDelegateWaterfallLayout {
    var chanel = ""
    ...
    */
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: kWallter, for: indexPath) as! WaterfallCell
...
// MARK: - CHTWaterfalllayout
extension WallterFallVC{
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        UIImage(named: "\(indexPath.item + 1)")!.size
    }
}

extension WallterFallVC: IndicatorInfoProvider{
